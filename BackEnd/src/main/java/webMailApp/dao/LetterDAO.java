...
import webMailApp.entities.EmailEntity;
import webMailApp.entities.FolderEntity;
import webMailApp.entities.LetterEntity;
...
public class LetterDAO {
     ...
     *  @param letterTheme letter theme
    ...
    /**
     *
     * @param letters list of letters that must be deleted
